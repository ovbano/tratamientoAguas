...
$lSup = 8;
$lInf = 6.5;
require_once "./../php/mapaB-3F-Fase2.php";
require_once './contar-marcadores.php';
$contadores = contarMarcadores($client->appexacta->Fase2final, $nameMapa, $lInf, $lSup);
?>
...
<head>
    ...
    <script>
        function initMap() {
            // Esta función será reemplazada por la del archivo mapaB-3F.php
            console.log('Mapa inicializado');
        }
    </script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvZX0GoEzqfo90MKNidUzliqGHk_L0brc&callback=initMap&loading=async&v=weekly" 
            async defer 
            onerror="gmapError()"></script> -->
...
<body>
        ...
        <div class="container text-center mt-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="mapa" style="height: 500px; width: 100%; border: 2px solid blue;"></div>
                    <br>
    ...
    <!-- Incluye el script del mapa como un archivo JavaScript externo -->
    <?php include_once "./../php/mapaB-3F-Fase2.php"; ?>
