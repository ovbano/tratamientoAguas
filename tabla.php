...
<div class="table-responsive">
  <table class="table table-bordered">
    <tbody>
      <tr>
        <th scope="row">Coliformes totales, NMP/Organismos/100 ml</th>
        <td>48 horas</td>
      </tr>
      <tr>
        <th scope="row">LÍMITE MAXIMO PERMITIDO</th>
        <td>&lt; 1.1</td>
      </tr>
      <tr>
        <th scope="row">MUESTRA</th>
        <td><?php echo $analisiMicrobiologico48 ?></td>
      </tr>
    </tbody>
...
<table class="dcf-table dcf-table-responsive dcf-table-bordered dcf-table-striped dcf-w-100%">
	...
	<thead>
		<tr>
			...
			<th scope="col">LÍMITE MÁXIMO PERMITIDO</th>
	...
	<tbody>
		<tr>
			<th scope="row">pH</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">8.5</td>
			<td data-label="MUESTRA"><?php echo $pH ?></td>
		</tr>
		<tr>
			<th scope="row">COLOR, Upt-Co</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">15</td>
			<td data-label="MUESTRA"><?php echo $analisisColor ?></td>
		</tr>
		<tr>
			<th scope="row">CLORO LIBRE RESIDUALmg/L</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">0.3-1.5</td>
			<td data-label="MUESTRA"><?php echo $analisisCloroResidual ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td data-label="MUESTRA"><?php echo $analisisConductividad ?></td>
		</tr>
		<tr>
			<th scope="row">MONOCLOROAMINAS, mg/L</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">3</td>
			<td data-label="MUESTRA"><?php echo $analisisMonocloroaminas ?></td>
		</tr>
		<tr>
			<th scope="row">NITRATOS,NO3 mg/L</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">50</td>
			<td data-label="MUESTRA"><?php echo $analisisNitratos ?></td>
		</tr>
    <tr>
			<th scope="row">NITRITOS,NO2 mg/L</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">0.2</td>
			<td data-label="MUESTRA"><?php echo $analisisNitritos ?></td>
		</tr>
		<tr>
			<th scope="row">analisisTurbNTU</th>
			<td data-label="LÍMITE MÁXIMO PERMITIDO">0.2</td>
    ...
    <tr>
			<td class="text-center" colspan="3"><?php echo $observaciones_enc2 ?></td>
		</tr>
	</tbody>
</table>
