<?php
require_once("./php/leerB-2FM-final.php");
?>
          ...
          <br>
            <table>
              <tr>
                    ...
                    <td class="auto-style78" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size: xx-large">
                        <center>Resultados de Análisis - Fase 2</center></td>
                </tr>
            </table>
            <br><br>
            <table>
                <tr>
                <center><label class="intro"><b>PROYECTO DE VINCULACIÓN</b><br> Diagnóstico de calidad de agua para consumo en Puerto Limón, Santo Domingo de los Tsáchilas, Ecuador</center></label>
                </tr>
                <br>
            </table>
            ...
            <table width="100%" class='table-responsive' class="auto-style31" style="border-style: solid; padding-top: 10px; border-collapse:separate">
                <tr class="linea1">
                    ...
                    <td class="auto-style69"><b>Código de muestra: </b> </td>
                    <td class="auto-style59">
                        <?php echo $codigo_encuesta ?>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style75"><b>Fecha de toma: </b> </td>
                    <td class="auto-style65">
                        <?php echo $fecha ?>
                    </td>
                    <td class="auto-style66"><b>Hora de toma: </b> </td>
                    <td class="auto-style46">
                        <?php echo $horaInicio ?>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style76"><b>Tipo de muestra: </b> </td>
                    <td class="auto-style50">
                        <?php echo $tipo_muestra ?>
                    </td>
                    <td class="auto-style51"><b>Punto de muestra: </b> </td>
                ...
                <tr>
                    ...
                    <td class="auto-style54">
                        <?php echo $latitud ?>, <?php echo $longitud ?>
                    </td>
                    <td class="auto-style51"><b>Dirección: </b> </td>
                    <td class="auto-style45">
                        <?php echo $caracteristica_casa ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style51"><b>Comunidad: </b> </td>
                    <td class="auto-style45">
                        <?php echo $comunidad ?>
                    </td>
                </tr>
            ...
            <!-- Incluir tabla de resultados específica para Fase 2 -->
            <?php include "tablaF-final.php"; ?>

        </div>

        <!-- <div><br><br>
            <a class="btn btn-success" onclick="history.back()">Atrás</a>
        </div> -->
